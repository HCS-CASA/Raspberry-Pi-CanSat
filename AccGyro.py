...
class accGyro(I2Clib.sensor):
    def __init__(self):
        ...
        self.write(0x1B, 0x00) #gyro config +- 250 degree/second
        self.write(0x6C, 0x00) #accelerometer config +- 2g
    ...
    def createFile(self, filename="AccGyro.csv"):
      with open(filename, 'w') as csvfile:
        ...
        csvwriter.writerow(['Acceleration x', 'Acceleration y', 'Acceleration z', 'Temperature', 'Gyroscope x', 'Gyroscope y', 'Gyroscope z'])
